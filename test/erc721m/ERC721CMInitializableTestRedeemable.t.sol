...
import "forge-std/console.sol"; // This should not be required but for whatever reason it is despite being imported by Test.sol
...
contract ERC721CMInitializableRedeemableTest is Test {
    ...
    function setUp() public {
        ...
        clone = LibClone.deployERC1967(
            address(new MockERC721CMInitializableRedeemable())
        );
    ...
    function testContractNameAndVersion() public view {
        (string memory name, string memory version) = nft
    ...
    function testRedeemBatch() public {
        ...
        nft.mint{value: 0.2 ether + mintFee * 2}(
            2,
            2,
            new bytes32[](0),
            block.timestamp,
    ...
    function testRedeemEmptyArrays() public {
        // Add redeemer
        nft.addAuthorizedRedeemer(address(this));
