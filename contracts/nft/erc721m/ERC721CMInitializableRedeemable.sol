...
import {ERC721CMInitializableV1_0_1} from "contracts/nft/erc721m/ERC721CMInitializableV1_0_1.sol";
    ...
    AuthorizedRedeemerControl
{
    ...
    function contractNameAndVersion()
        public
        pure
        override
    ...
    ) external onlyAuthorizedRedeemer {
    ...
    function addAuthorizedRedeemer(
        address redeemer
    ...
    function removeAuthorizedRedeemer(
        address redeemer
    ) external override onlyOwner {
